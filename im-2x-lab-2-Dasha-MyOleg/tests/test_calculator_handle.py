...
def test_parse():
    # Перевірка правильного парсингу
...
def test_calculate():
    # Перевірка правильних обчислень
...
def test_handle_key_press_invalid_sequences():
    # Тест некоректних послідовностей

    # Дві операції поспіль
    state = CalculatorState()
    handle_key_press(state, "1")
    handle_key_press(state, "+")
    try:
